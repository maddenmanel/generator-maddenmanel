...
<%=packageName%>.<%=baseName%>.configration;
...
import <%=packageName%>.<%=baseName%>.interceptor.EasyValidInterceptor;
...
public class EasyUseConfig {
  ...
  public DefaultPointcutAdvisor easyValidAnnotationClassPointCut() {
    ...
    EasyValidInterceptor interceptor = new EasyValidInterceptor();
    advisor.setPointcut(pointcut);
    advisor.setAdvice(interceptor);
    return advisor;
  }
